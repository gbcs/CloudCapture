...
@implementation StillControllBarView2
...
-(void)test {
    [_delegate userTappedWhiteBalanceButton];
    [_delegate userTappedExposureButton];
    [_delegate userTappedFocusButton];
    [_delegate usertappedFlashButton];
}
