//
//  AudioEditorConfirmViewController.m
//  Capture
//
...
@interface AudioEditorConfirmViewController () {
...
@implementation AudioEditorConfirmViewController
...
-(void)userTappedCommit {
    ...
    [[UtilityBag bag] logEvent:@"cutAudio" withParameters:nil];
