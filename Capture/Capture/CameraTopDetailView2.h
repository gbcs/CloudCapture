...
@interface CameraTopDetailView2 : UIView
<GradientAttributedButtonDelegate, UITableViewDataSource, UITableViewDelegate, UITextViewDelegate, FilterToolHistogramDelegate>
